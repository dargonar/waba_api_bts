...
#       library_dirs = ['/usr/include/boost/lib', '/usr/local/lib' , '%s/utilities' % lroot, '%s/chain' % lroot , '%s/db' % lroot , '%s/fc' % lroot, '%s/fc/vendor/secp256k1-zkp/src/project_secp256k1-build/.libs' % lroot ]
#     )
#   ]
# )
